...
export class ConnectCommand implements CommandInfo {
...
export class DisconnectCommand implements CommandInfo {
...
export class CreateCommand implements CommandInfo {
